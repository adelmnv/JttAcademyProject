        ...
        <div class="container mx-auto mt-10">
            <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="flex items-center justify-end  mb-4">
                    ...
                    <a href="{{ route('admin.memberships_edit', ['membership_id' => $membership->id]) }}" class="bg-yellow-500 text-white ml-4 px-4 py-2 rounded-full hover:bg-yellow-600 transition-all duration-300">Редактировать</a>
                </div>
            </div>
        </div>
    </div>
